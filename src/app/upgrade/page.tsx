        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="bg-white rounded-2xl border-2 border-blue-200 p-8 relative">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600">For serious investors building portfolios</p>
            </div>
          ...
          {/* Enterprise Tier */}
          <div className="bg-white rounded-2xl border-2 border-purple-200 p-8 transform scale-105 shadow-xl">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600">For portfolio builders and teams</p>
            </div>
            <ul className="space-y-3 mb-8">
        ...
        <div className="bg-white rounded-2xl p-6 border border-gray-200">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">You're currently on the {user?.subscription} plan</p>
            </div>
            <Link
              href="/dashboard"
